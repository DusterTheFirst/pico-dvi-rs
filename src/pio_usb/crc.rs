...
#[link_section = ".data"]
pub fn calc_usb_crc5(data: u16) -> u8 {
    ...
    // This is optimized more than most implementations; length is
    // fixed so result is xor with crc of 0
    crc ^ 2
}

#[link_section = ".data"]
static CRC16_TBL: [u16; 256] = [
...
#[link_section = ".data"]
pub fn update_crc_16(crc: u16, data: u8) -> u16 {
    (crc >> 8) ^ CRC16_TBL[(crc as u8 ^ data) as usize]
}
