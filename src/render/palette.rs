...
pub fn init_4bpp_palette(pal: &mut [PaletteEntry; 256], rgb: &[u32]) {
...
static GRAY_4BPP: [TmdsPair; 256] = [
    // This was auto-generated by garden/tmds.py
    TmdsPair::encode_pair(0x0, 0x1),   // (+0, +1)
    TmdsPair::encode_pair(0xe, 0x2),   // (-3, +2)
    TmdsPair::encode_pair(0x1f, 0x4),  // (-3, +4)
    TmdsPair::encode_pair(0x31, 0x1),  // (-2, +1)
    TmdsPair::encode_pair(0x41, 0x2),  // (-3, +2)
    TmdsPair::encode_pair(0x52, 0x4),  // (-3, +4)
    TmdsPair::encode_pair(0x66, 0x2),  // (+0, +2)
    TmdsPair::encode_pair(0x78, 0x2),  // (+1, +2)
    TmdsPair::encode_pair(0x87, 0x2),  // (-1, +2)
    TmdsPair::encode_pair(0x99, 0x2),  // (+0, +2)
    TmdsPair::encode_pair(0xa6, 0x4),  // (-4, +4)
    TmdsPair::encode_pair(0xb8, 0x4),  // (-3, +4)
    TmdsPair::encode_pair(0xce, 0x1),  // (+2, +1)
    TmdsPair::encode_pair(0xda, 0x4),  // (-3, +4)
    TmdsPair::encode_pair(0xeb, 0x4),  // (-3, +4)
    TmdsPair::encode_pair(0xff, 0x1),  // (+0, +1)
    TmdsPair::encode_pair(0x3, 0xf),   // (+3, -2)
    ...
    TmdsPair::encode_pair(0x4, 0x1f),  // (+4, -3)
    ...
    TmdsPair::encode_pair(0x3, 0x31),  // (+3, -2)
    TmdsPair::encode_pair(0xf, 0x35),  // (-2, +2)
    ...
    TmdsPair::encode_pair(0x4, 0x40),  // (+4, -4)
    ...
    TmdsPair::encode_pair(0x5, 0x51),  // (+5, -4)
    ...
    TmdsPair::encode_pair(0x2, 0x66),  // (+2, +0)
    ...
    TmdsPair::encode_pair(0x2, 0x78),  // (+2, +1)
    ...
    TmdsPair::encode_pair(0x3, 0x86),  // (+3, -2)
    ...
    TmdsPair::encode_pair(0x3, 0x98),  // (+3, -1)
    ...
    TmdsPair::encode_pair(0x4, 0xa6),  // (+4, -4)
    ...
    TmdsPair::encode_pair(0x4, 0xb8),  // (+4, -3)
    ...
    TmdsPair::encode_pair(0x2, 0xcd),  // (+2, +1)
    ...
    TmdsPair::encode_pair(0x4, 0xda),  // (+4, -3)
    ...
    TmdsPair::encode_pair(0x4, 0xeb),  // (+4, -3)
    ...
    TmdsPair::encode_pair(0x0, 0xfe),  // (+0, -1)
